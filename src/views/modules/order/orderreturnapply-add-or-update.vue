  ...
  >
    ...
    >
      ...
      <el-form-item label="退款金额" prop="returnAmount">
        <el-input
          v-model="dataForm.returnAmount"
          placeholder="退款金额"
        ></el-input>
      </el-form-item>
      <el-form-item label="退货人姓名" prop="returnName">
        <el-input
          v-model="dataForm.returnName"
          placeholder="退货人姓名"
        ></el-input>
      </el-form-item>
      <el-form-item label="退货人电话" prop="returnPhone">
        <el-input
          v-model="dataForm.returnPhone"
          placeholder="退货人电话"
        ></el-input>
      </el-form-item>
      <el-form-item
      ...
      >
        <el-input
          ...
          placeholder="申请状态[0->待处理；1->退货中；2->已完成；3->已拒绝]"
        ></el-input>
      </el-form-item>
      ...
      <el-form-item label="商品实际支付单价" prop="skuRealPrice">
        <el-input
          v-model="dataForm.skuRealPrice"
          placeholder="商品实际支付单价"
        ></el-input>
      </el-form-item>
      ...
      <el-form-item label="描述" prop="description述">
        <el-input
          v-model="dataForm.description述"
          placeholder="描述"
        ></el-input>
      </el-form-item>
      <el-form-item label="凭证图片，以逗号隔开" prop="descPics">
        <el-input
          v-model="dataForm.descPics"
          placeholder="凭证图片，以逗号隔开"
        ></el-input>
      </el-form-item>
      <el-form-item label="处理备注" prop="handleNote">
        <el-input
          v-model="dataForm.handleNote"
          placeholder="处理备注"
        ></el-input>
      </el-form-item>
      <el-form-item label="处理人员" prop="handleMan">
        <el-input
          v-model="dataForm.handleMan"
          placeholder="处理人员"
        ></el-input>
      </el-form-item>
