  ...
  >
    ...
    >
      ...
      <el-form-item label="用户名" prop="memberUsername">
        <el-input
          v-model="dataForm.memberUsername"
          placeholder="用户名"
        ></el-input>
      </el-form-item>
      ...
      <el-form-item label="应付总额" prop="payAmount">
        <el-input
          v-model="dataForm.payAmount"
          placeholder="应付总额"
        ></el-input>
      </el-form-item>
      <el-form-item label="运费金额" prop="freightAmount">
        <el-input
          v-model="dataForm.freightAmount"
          placeholder="运费金额"
        ></el-input>
      </el-form-item>
      <el-form-item
      ...
      >
        <el-input
          ...
          placeholder="促销优化金额（促销价、满减、阶梯价）"
        ></el-input>
      </el-form-item>
      <el-form-item label="积分抵扣金额" prop="integrationAmount">
        <el-input
          v-model="dataForm.integrationAmount"
          placeholder="积分抵扣金额"
        ></el-input>
      </el-form-item>
      ...
      <el-form-item label="后台调整订单使用的折扣金额" prop="discountAmount">
        <el-input
          v-model="dataForm.discountAmount"
          placeholder="后台调整订单使用的折扣金额"
        ></el-input>
      </el-form-item>
      <el-form-item
      ...
      <el-form-item label="订单来源[0->PC订单；1->app订单]" prop="sourceType">
        <el-input
          ...
          placeholder="订单来源[0->PC订单；1->app订单]"
        ></el-input>
      </el-form-item>
      <el-form-item
      ...
      <el-form-item label="物流公司(配送方式)" prop="deliveryCompany">
        <el-input
          v-model="dataForm.deliveryCompany"
      ...
      <el-form-item label="自动确认时间（天）" prop="autoConfirmDay">
        <el-input
          v-model="dataForm.autoConfirmDay"
          placeholder="自动确认时间（天）"
        ></el-input>
      </el-form-item>
      ...
      <el-form-item label="可以获得的成长值" prop="growth">
        <el-input
          v-model="dataForm.growth"
          placeholder="可以获得的成长值"
        ></el-input>
      </el-form-item>
      <el-form-item
      ...
      <el-form-item label="收货人电话" prop="receiverPhone">
        <el-input
          v-model="dataForm.receiverPhone"
          placeholder="收货人电话"
        ></el-input>
      </el-form-item>
      <el-form-item label="收货人邮编" prop="receiverPostCode">
        <el-input
          v-model="dataForm.receiverPostCode"
          placeholder="收货人邮编"
        ></el-input>
      </el-form-item>
      <el-form-item label="省份/直辖市" prop="receiverProvince">
        <el-input
          v-model="dataForm.receiverProvince"
          placeholder="省份/直辖市"
        ></el-input>
      </el-form-item>
      ...
      <el-form-item label="详细地址" prop="receiverDetailAddress">
        <el-input
          v-model="dataForm.receiverDetailAddress"
          placeholder="详细地址"
        ></el-input>
      </el-form-item>
      ...
      >
        <el-input
          ...
          placeholder="确认收货状态[0->未确认；1->已确认]"
        ></el-input>
      </el-form-item>
      <el-form-item
      ...
      >
        <el-input
          v-model="dataForm.deleteStatus"
          placeholder="删除状态【0->未删除；1->已删除】"
        ></el-input>
      </el-form-item>
      <el-form-item label="下单时使用的积分" prop="useIntegration">
        <el-input
          v-model="dataForm.useIntegration"
          placeholder="下单时使用的积分"
        ></el-input>
      </el-form-item>
